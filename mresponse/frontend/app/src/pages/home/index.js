...
import { getModerateQueue, getRespondQueue, getFeedbackLink, getAboutLink, getProfile, getApiToken } from '@redux/selectors'
...
const mapDispatchToProps = (dispatch, props) => ({
  ...
  updateAppConfig: (api) => dispatch(updateAppConfig(api)),
  updateHomeConfig: (api) => dispatch(updateHomeConfig(api))
})
