...
export default class HelpDocs extends React.Component {
  ...
  componentWillMount () {
    if (this.props.openTo) this.setState({ isListOpen: true })
  }

  render () {
    const { className = '', data, openTo } = this.props
        ...
        <div className='help-docs-inner'>
          ...
          <CSSTransitionGroup
            ...
            {isListOpen ? <div className="help-docs-document">
              <Toolbar
                ...
                title={openTo || 'This is a title'}
                onBack={this.toggListOptions} />
              <div className="help-docs-document-inner">
          ...
          <div className='help-docs-content'>
            <div className='help-docs-content-list'>
              ...
              <ul className='' data-remove={data} data-removealso={openTo}>
                <li>
