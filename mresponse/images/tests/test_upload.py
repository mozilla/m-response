...
class TestImageUpload(TestCase):
    ...
    def test_upload(self):
        response = self.client.post(reverse('images:upload'), {
            'image': SimpleUploadedFile('test.png', get_test_image_file().file.getvalue()),
    ...
    def test_upload_without_image(self):
        response = self.client.post(reverse('images:upload'), HTTP_X_REQUESTED_WITH='XMLHttpRequest')
    ...
    def test_upload_with_wrong_extension(self):
        response = self.client.post(reverse('images:upload'), {
            'image': SimpleUploadedFile('test.jpg', get_test_image_file().file.getvalue()),
        }, HTTP_X_REQUESTED_WITH='XMLHttpRequest')
