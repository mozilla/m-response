...
export default class SettingsPage extends React.Component {
	state = {name: null, avatar: null, email: null, languages: null, password: null, passwordConfirm: null}
	...
	static getDerivedStateFromProps(props, state) {
		return {
			...
			languages: (state.languages != null) ? state.languages : props.profile.languages,
		}
	}
		...
		return (
			<div className="settings">
				...
				<section className='settings-user-meta'>
					<span className='settings-edit-button' onClick={() => this.saveProfile()}>Done</span>

					<div className='settings-avatar'>
						<Avatar editable={true} src={avatar} onClick={() => this.avatarUploadField.current.click()} />
					</div>
				...
				<section className='settings-languages'>
					{languages.map(({text}) => <span className='settings-languages-tag'>{text}</span>)}
				</section>
	...
	saveProfile() {
		const { name, email, avatar, avatarUpload, password, passwordConfirm } = this.state
