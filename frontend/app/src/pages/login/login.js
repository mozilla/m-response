		...
		return (
			<div className='login-page'>
				<header className='toolbar'>
					<img className='toolbar-back-icon' src={this.props.icon || '/static/media/icons/back-chevron.svg'} onClick={() => this.goBack()}/>
					<img className='toolbar-logo' src='/static/media/mozilla-logo.png'/>
					<span onClick={() => this.toggleRoute()} className='toolbar-login-link'>
				...
				<section className='login-page-content'>
					...
					<Route path={LOGIN_URL} component={
						() => <LoginForm login={this.props.login} forgotPassword={() => this.props.history.push(FORGOT_PASSWORD_URL)}/>
					}/>
					<Route path={SIGNUP_URL} component={
						() => <SignupForm ref={this.signupForm} createAccount={this.props.createAccount} />
					}/>
					<Route path={FORGOT_PASSWORD_URL} component={
